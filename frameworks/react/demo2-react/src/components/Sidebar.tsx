            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    ...
                    <g id="SVGRepo_iconCarrier">
                      <path d="M8 14h6v2H8zM8 6h12v2H8zM8 10h12v2H8zM8 24h6v2H8zM30 24v-2h-2.101a5 5 0 0 0-.732-1.753l1.49-1.49-1.414-1.414-1.49 1.49A5 5 0 0 0 24 18.101V16h-2v2.101a5 5 0 0 0-1.753.732l-1.49-1.49-1.414 1.414 1.49 1.49A5 5 0 0 0 18.101 22H16v2h2.101a5 5 0 0 0 .732 1.753l-1.49 1.49 1.414 1.414 1.49-1.49a5 5 0 0 0 1.753.732V30h2v-2.101a5 5 0 0 0 1.753-.732l1.49 1.49 1.414-1.414-1.49-1.49A5 5 0 0 0 27.899 24Zm-7 2a3 3 0 1 1 3-3 3.003 3.003 0 0 1-3 3"></path>
                      <path d="M14 30H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10h-2V4H6v24h8Z"></path>
                      <path
              ...
              <li>
                ...
                >
                  ...
                  >
                    <g>
                      <path d="M38.3 27.2a11.4 11.4 0 1 0 11.4 11.4 11.46 11.46 0 0 0-11.4-11.4m2 12.4a2.4 2.4 0 0 1-.9-.2l-4.3 4.3a1.4 1.4 0 0 1-.9.4 1 1 0 0 1-.9-.4 1.39 1.39 0 0 1 0-1.9l4.3-4.3a3 3 0 0 1-.2-.9 3.47 3.47 0 0 1 3.4-3.8 2.4 2.4 0 0 1 .9.2c.2 0 .2.2.1.3l-2 1.9a.28.28 0 0 0 0 .5l1.3 1.3a.38.38 0 0 0 .6 0l1.9-1.9c.1-.1.4-.1.4.1a3.7 3.7 0 0 1 .2.9 3.57 3.57 0 0 1-3.9 3.5"></path>
                      <circle cx="21.7" cy="14.9" r="12.9"></circle>
                      <path d="M25.2 49.8c2.2 0 1-1.5 1-1.5a15.44 15.44 0 0 1-3.4-9.7 15 15 0 0 1 1.4-6.4.8.8 0 0 1 .2-.3c.7-1.4-.7-1.5-.7-1.5a12 12 0 0 0-1.9-.1A19.69 19.69 0 0 0 2.4 47.1c0 1 .3 2.8 3.4 2.8h19.1c.2-.1.2-.1.3-.1"></path>
                    </g>
                  </svg>
                  Roles
                </NavLink>
